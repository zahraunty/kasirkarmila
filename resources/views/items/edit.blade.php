        ...
        <div
            ...
            <form action="{{ route('items.update', $item) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        <label for="price" class="px-6 py-4 whitespace-nowrap text-sm text-stone-900 dark:text-white">
                            Harga Barang</label>
                    ...
                    <div class="space-y-2">
                        <label for="stock" class="px-6 py-4 whitespace-nowrap text-sm text-stone-900 dark:text-white">
                            Stok Barang</label>
                    ...
                    <div class="space-y-2">
                        <label for="diskon" class="px-6 py-4 whitespace-nowrap text-sm text-stone-900 dark:text-white">
                            Diskon</label>
                        <input type="number" name="diskon" id="diskon" value="{{ $item->diskon }}"
                            class="w-full px-4 py-2 border border-amber-300 dark:border-amber-600 rounded-md shadow-sm bg-white dark:bg-stone-700 text-stone-800 dark:text-amber-100 focus:ring-2 focus:ring-amber-500 focus:outline-none transition-colors duration-300 text-sm"
