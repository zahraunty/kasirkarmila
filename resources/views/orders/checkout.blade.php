<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-orange-800 dark:text-orange-200 leading-tight">
            {{ __('Nota Pembelian') }}
        </h2>
    </x-slot>
    ...
    <div class="py-10 max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-900 shadow-lg rounded-lg p-8">
            <h2 class="text-3xl font-bold mb-6 text-orange-800 dark:text-orange-200 tracking-wide">Detail Pesanan</h2>
                ...
                <table class="min-w-full border border-gray-300 dark:border-gray-700 rounded-lg table-auto">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300">
                        ...
                        @else
                            <tr>
                                <td colspan="7"
                                    class="px-6 py-4 text-center text-gray-400 dark:text-gray-600 text-sm italic">Tidak ada
                                    data pesanan yang tersedia.</td>
                            </tr>
                        @endif
                    </tbody>
                    <tfoot class="bg-orange-100 dark:bg-orange-800">
                        <tr>
                            <td colspan="5"
                                class="px-6 py-3 text-right font-bold text-gray-700 dark:text-gray-300 uppercase text-sm tracking-wider">
                                Diskon Yang Didapatkan</td>
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <button id="print-button"
                    class="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 px-7 rounded shadow-md transition duration-300">Cetak</button>
                <a href="{{ route('transactions.index') }}"
                    class="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-7 rounded shadow-md transition duration-300">Selesai</a>
            </div>
        </div>
    </div>
